...
--    , ((modm .|. shiftMask, xK_p     ), spawn "gmrun")
    ...
    -- launch emacs
    , ((modm,               xK_m     ), spawn "emacsclient -c -a 'emacs'")
...
myLayout = (avoidStruts $ mySpacing(8) tiled) ||| noBorders Full
  where
...
main = do
  ...
  xmonad $ docks defaults
    {logHook = dynamicLogWithPP xmobarPP
              ...
              , ppCurrent = xmobarColor "#0975ff" "" . wrap
                "[" "]"
              -- Underline
